...
void PV_napc_sha__testCase89(void);
void PV_napc_sha__testCase90(void);
void PV_napc_sha__testCase91(void);
void PV_napc_writer__testCase92(void);
void PV_napc_writer__testCase93(void);
void PV_napc_writer__testCase94(void);
void PV_napc_writer__testCase95(void);
void PV_napc_writer__testCase96(void);
...
void napc_sha__runTests(void) {
    PV_napc_sha__testCase89(); napc_unmute(); napc_puts("passed!\n"); napc_mute();
    PV_napc_sha__testCase90(); napc_unmute(); napc_puts("passed!\n"); napc_mute();
    PV_napc_sha__testCase91(); napc_unmute(); napc_puts("passed!\n"); napc_mute();
    napc_unmute();
...
void napc_writer__runTests(void) {
    ...
    PV_napc_writer__testCase93(); napc_unmute(); napc_puts("passed!\n"); napc_mute();
    PV_napc_writer__testCase94(); napc_unmute(); napc_puts("passed!\n"); napc_mute();
    PV_napc_writer__testCase95(); napc_unmute(); napc_puts("passed!\n"); napc_mute();
    PV_napc_writer__testCase96(); napc_unmute(); napc_puts("passed!\n"); napc_mute();
